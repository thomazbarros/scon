 ...
 */
public class RdfXmlFactory implements ParserFactory {
   ...
   */
  public ResultParser createParser(InputStream input, Statement stmt) throws InternalException, IOException {
    return new XMLGraphParser(input, stmt);
  }
